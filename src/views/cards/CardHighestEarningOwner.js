...
const CardHighestEarningOwner = () => {
  ...
  useEffect(() => {
    ...
    if (highestEarningOwners) setDataFromAPI(highestEarningOwners)
    else getDataFromAPI()
  }, [])
  ...
  const getDataFromAPI = async () => {
    ...
    fetch('http://161.35.118.186/mkulima/dereva/pesa', requestOptions)
      ...
      .then(result => {
        ...
        // window.localStorage.setItem(authConfig.storageHighestEarningOwners, JSON.stringify(result.data))
